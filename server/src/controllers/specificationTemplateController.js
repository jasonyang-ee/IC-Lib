...
export const getSpecificationTemplates = async (req, res) => {
  try {
...
export const createSpecificationTemplate = async (req, res) => {
  try {
...
export const updateSpecificationTemplate = async (req, res) => {
  try {
    const { id } = req.params;
...
export const deleteSpecificationTemplate = async (req, res) => {
  try {
    const { id } = req.params;
