      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white dark:bg-[#2a2a2a] rounded-lg shadow-md p-8 border border-gray-200 dark:border-[#3a3a3a]">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-2 bg-gray-500 hover:bg-gray-600 disabled:bg-gray-400 text-white font-semibold py-3 px-4 rounded-lg transition-colors"
          >
            <LogIn className="w-5 h-5" />
