 ...
 */
const BulkAlternativeClassModal = ({ isOpen, selectedCount, excludedCount, onApply, onClose }) => {
    ...
    <Modal
      ...
      footer={
        <>
          ...
          >
            Apply to {selectedCount} Component{selectedCount === 1 ? '' : 's'}
          </button>
        </>
      }
    >
      <AlternativeClassSelect value={altClass} onChange={setAltClass} />
