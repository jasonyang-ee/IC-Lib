...
INSERT INTO component_specifications (component_id, spec_name, spec_value, unit) VALUES
    ...
    ((SELECT id FROM components WHERE part_number = 'RES-0002'), 'Tolerance', '1', '%'),
    ((SELECT id FROM components WHERE part_number = 'RES-0003'), 'Power Rating', '0.1', 'W');
...
INSERT INTO component_specifications (component_id, spec_name, spec_value, unit) VALUES
    ...
    ((SELECT id FROM components WHERE part_number = 'CAP-0002'), 'Voltage Rating', '50', 'V'),
    ((SELECT id FROM components WHERE part_number = 'CAP-0003'), 'Tolerance', '±10', '%');
